...
public class AnonymousConsentController extends AbstractPageController {
	...
	public ResponseEntity giveConsent(@PathVariable final String consentTemplateId,
			@RequestParam final String consentState, final HttpServletRequest request,
		...
		try {
			...
			final List<AnonymousConsentData> updatedList = anonymousConsentDataList.stream()
					.peek(anonymousConsentData -> {
